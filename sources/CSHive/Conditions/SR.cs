...
namespace CS.Conditions
{
    ...
    internal static class SR
    {
        ...
        private static readonly ResourceManager Res =  new ResourceManager(typeof (SR).Namespace + ".ExceptionMessages", typeof (SR).Assembly);

        // Returns a string from the Res.
        internal static string GetString(string name)
        {
            return GetStringInternal(name, null);
        }

        // Returns a string from the Res and formats it with the given args in a culture-specific way.
        ...
        private static string GetStringInternal(string name, params object[] args)
        {
            ...
            var format = Res.GetString(name, CultureInfo.CurrentUICulture);
